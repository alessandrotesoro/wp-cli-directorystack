...
function ds_demo_taxonomies() {
	...
	$labels = array(
		'name'                       => _x( 'Taxonomy Demo 1', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Taxonomy Demo 1', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Taxonomy Demo 1', 'text_domain' ),
	...
	$labels2 = array(
		'name'                       => _x( 'Taxonomy Demo 2', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Taxonomy Demo 2', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Taxonomy Demo 2', 'text_domain' ),
		'all_items'                  => __( 'All Items', 'text_domain' ),
		'parent_item'                => __( 'Parent Item', 'text_domain' ),
		'parent_item_colon'          => __( 'Parent Item:', 'text_domain' ),
		'new_item_name'              => __( 'New Item Name', 'text_domain' ),
